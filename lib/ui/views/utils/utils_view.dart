          ...
          child: Column(
            ...
            children: [
              ...
              SkyButton(
                ...
                outlineMode: true,
                onPressed: () => navigator.push(MediaUtilsView.route),
              ),
              const SizedBox(height: 12),
              SkyButton(
                ...
                outlineMode: true,
                onPressed: () => navigator.push(BottomSheetUtilsView.route),
              ),
              const SizedBox(height: 12),
              SkyButton(
                text: 'List Utility',
                icon: Icons.list,
                outlineMode: true,
                onPressed: () => navigator.push(ListUtilsView.route),
              ),
              const SizedBox(height: 12),
              SkyButton(
                text: 'Dialog Utility',
                ...
                outlineMode: true,
                onPressed: () => navigator.push(DialogUtilsView.route),
              ),
              const SizedBox(height: 12),
              SkyButton(
                ...
                outlineMode: true,
                onPressed: () => navigator.push(SnackBarUtilsView.route),
              ),
              const SizedBox(height: 12),
              SkyButton(
                text: 'Other',
                icon: Icons.add,
                outlineMode: true,
                onPressed: () => navigator.push(OtherUtilsView.route),
              ),
              const SizedBox(height: 12),
              SkyButton(
                ...
                onPressed: () => navigator.push(ThemeComponentUtilsView.route),
              ),
